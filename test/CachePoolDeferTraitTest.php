...
use Cl\Cache\CacheItemPool\CacheItemPoolDeferTrait;

/**
 * @covers Cl\Cache\Trait\CacheItemPool\CacheItemPoolDeferTrait
 */
class CachePoolDeferTraitTest extends TestCase
{
    ...
    {
        $this->traitStub = $this->getMockForTrait(CacheItemPoolDeferTrait::class);
